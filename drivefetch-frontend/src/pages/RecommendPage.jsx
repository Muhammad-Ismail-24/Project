...
export default function RecommendPage() {
  ...
  return (
    <main className="relative w-full flex-grow flex flex-col font-body bg-white dark:bg-zinc-950 text-df-black dark:text-zinc-50 selection:bg-df-black selection:text-df-white overflow-x-hidden">
      ...
      <div 
        className="absolute inset-0 z-0 bg-white dark:bg-zinc-950 dark:opacity-20"
        style={{
          backgroundImage: `
      ...
      <div className="relative z-10 flex-1 w-full max-w-5xl mx-auto px-5 pt-16 pb-32 flex flex-col">
        ...
        <div className="text-center mb-12 sm:mb-16 mt-8 sm:mt-12">
          <h1 className="inline-block text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tighter text-df-black dark:text-zinc-50 uppercase">
        ...
        <div className="w-full max-w-3xl mx-auto relative z-10">
          <div className="relative bg-df-white dark:bg-black border-2 border-df-black dark:border-white shadow-[8px_8px_0px_#000000] dark:shadow-[8px_8px_0px_#ffffff] flex flex-col transition-all focus-within:border-[#E5202E] focus-within:ring-2 focus-within:ring-[#E5202E] focus-within:shadow-[12px_12px_0px_#000000] dark:focus-within:shadow-[12px_12px_0px_#ffffff]">
            ...
            <textarea
              ...
              className="w-full min-h-[160px] p-5 sm:p-6 pb-20 bg-transparent font-mono text-base sm:text-lg text-df-black dark:text-zinc-50 placeholder-df-black/30 dark:placeholder-zinc-50/30 resize-none focus:ring-0 focus:outline-none"
              style={{
                lineHeight: '32px',
        ...
        {loading && (
          <div className="w-full max-w-3xl mx-auto mt-10">
            <div className="bg-df-white dark:bg-black border-2 border-df-black dark:border-white shadow-[6px_6px_0px_#000000] dark:shadow-[6px_6px_0px_#ffffff] p-6 sm:p-8">
              ...
              {stageLabel && (
                <p className="font-mono text-[10px] sm:text-xs font-bold text-df-black/50 dark:text-zinc-50/50 uppercase tracking-[0.05em]">
                  {stageLabel}
                </p>
              )}
              ...
              {targets.length > 0 && (
                <div className="mt-8 pt-6 border-t-2 border-df-black dark:border-white border-dashed">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {targets.map((t, i) => (
                      <span key={i} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-df-black dark:bg-white text-df-white dark:text-black font-mono text-[10px] sm:text-xs font-bold uppercase shadow-[2px_2px_0px_#E5202E]">
                ...
                <div className="space-y-4">
                  {targets.map((t, i) => (
                    <div key={i} className="flex flex-col sm:flex-row items-start gap-4 p-4 sm:p-5 border-2 border-df-black dark:border-white bg-df-grey dark:bg-zinc-900">
                      ...
                      <div>
                        <span className="font-mono text-sm sm:text-base font-bold text-df-black dark:text-zinc-50 uppercase tracking-wide block mb-1.5">
                        ...
                        {t.rationale && (
                          <p className="font-body text-xs sm:text-sm font-medium text-df-black/70 dark:text-zinc-50/70 leading-relaxed">{t.rationale}</p>
                        )}
                      </div>
                    </div>
                  ))}
            ...
            {extListings.length > 0 && (
              <div className="mt-16 space-y-10">
                <div className="flex items-center gap-4">
                  <div className="h-1 flex-1 bg-df-black dark:bg-white" />
                  <span className="font-mono text-base font-black text-df-black dark:text-zinc-50 uppercase tracking-widest">
                    [ EXTENDED MATCHES ]
                  </span>
                  <div className="h-1 flex-1 bg-df-black dark:bg-white" />
                </div>
        ...
        {!loading && !error && listings.length === 0 && stage === "complete" && (
          <div className="w-full max-w-3xl mx-auto mt-10">
             <div className="bg-df-white dark:bg-black border-2 border-df-black dark:border-white shadow-[8px_8px_0px_#000000] dark:shadow-[8px_8px_0px_#ffffff] p-10 text-center">
               ...
               <p className="font-body text-sm font-medium text-df-black/60 dark:text-zinc-50/60">
