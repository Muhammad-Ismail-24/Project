      ...
      <div className="relative z-10 w-full">
        ...
        <div className="min-h-[80vh] lg:min-h-screen flex flex-col justify-center px-6 max-w-7xl mx-auto pt-32 lg:pt-40 pb-16 lg:pb-0">
          <motion.div className="max-w-md" variants={heroContainerVariants} initial="hidden" animate="visible">
            <motion.div variants={heroItemVariants}>
              <div className="inline-flex items-center px-4 py-1.5 md:px-5 md:py-2 rounded-full bg-black text-white text-[10px] md:text-xs font-bold tracking-widest uppercase mb-6 md:mb-8 shadow-md">
                GaariGuru AI Engine
              </div>
            </motion.div>
            ...
            <motion.p variants={heroItemVariants} className="text-lg md:text-xl font-bold text-black">
        ...
        <div className="min-h-[70vh] lg:min-h-screen flex flex-col justify-center px-6 max-w-7xl mx-auto py-16 lg:py-0">
          <div className="max-w-md">
            ...
            <p className="text-base md:text-lg font-bold text-black leading-relaxed mb-6 md:mb-8">
            ...
            <div className="flex flex-wrap gap-2 md:gap-3">
              {['PakWheels', 'OLX Pakistan', 'Drive.pk', 'Gari.pk'].map(platform => (
                <span key={platform} className="px-4 py-2 md:px-5 md:py-2.5 bg-[#a3a3a3] border border-black/15 shadow-md rounded-full text-xs md:text-sm font-bold tracking-wide text-black cursor-default">
                  {platform}
                </span>
              ))}
            </div>
        ...
        <div id="search-section" className="min-h-[80vh] lg:min-h-screen px-6 pt-24 lg:pt-32 pb-[30vh] lg:pb-[40vh] relative z-20">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10 md:mb-12">
              <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-3 md:mb-4 text-black">
                Start Your Search
              </h2>
            ...
            <div className="mt-16 md:mt-24 space-y-8 md:space-y-12">
              {isLoading && (
                <div className="flex flex-col items-center justify-center py-16 md:py-20 space-y-4">
                  ...
                  <p className="text-base md:text-lg font-bold text-black animate-pulse text-center">
              ...
              {error && (
                <div className="flex items-center space-x-3 bg-white/60 backdrop-blur-md border border-black/15 shadow-md text-black p-5 md:p-6 rounded-2xl">
              ...
              {bestPick && !isLoading && (
                <div className="space-y-4 md:space-y-6">
                  <div className="inline-flex items-center space-x-2 bg-black text-white font-bold text-xs md:text-sm uppercase px-3 py-1.5 md:px-4 md:py-1.5 rounded-full tracking-wider shadow-md">
